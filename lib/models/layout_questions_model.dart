...
class LayOutQuestion {
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'isLocked': isLocked,
      'selectedWiidgetOption': selectedWiidgetOption?.toJson(),
  ...
  factory LayOutQuestion.fromJson(Map<String, dynamic> json) {
    return LayOutQuestion(
      id: json['id'],
      text: json['text'],
      options: List<LayOutOption>.from(
          json['options'].map((option) => LayOutOption.fromJson(option))),
      isLocked: json['isLocked'],
      selectedWiidgetOption: json['selectedWiidgetOption'] != null
          ? LayOutOption.fromJson(json['selectedWiidgetOption'])
          : null,
      correctAnswer: json['correctAnswer'] != null
          ? LayOutOption.fromJson(json['correctAnswer'])
          : null,
    );
  }
}
