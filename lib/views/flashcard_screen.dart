      ...
      body: SafeArea(
        child: Center(
          child: WidgetStateConsumer(
              widgetStateNotifier: widget.questionNotifier.stateNotifier,
              widgetStateBuilder: (context, snapshot) {
                final questions = getRandomQuestionsAndOptions(
                    snapshot ?? widget.questionNotifier.getLatestQuestions());
                return ListView(
                        ...
                        ElevatedButton(
                          style: ButtonStyle(
                            ...
                            fixedSize: MaterialStateProperty.all(
                              Size(
                                  MediaQuery.of(context).size.width * 0.85, 30),
                            ),
